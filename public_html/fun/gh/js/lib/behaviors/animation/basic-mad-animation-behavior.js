...
/*
 BasicMadAnimationBehavior

 Note: use with round-robin priority manager
 */
var basicMadAnimationBehavior = {
    name: "BasicMadAnimationBehavior",
    think: {
        facts: [
            {
    ...
    tasks: {
        ...
        attemptMove: function (args) {
            ...
            var nearDistance = this_agent.recall({ name: "nearDistance" });
            ...
            if (tasks.nearLocation(position,targetLocation, nearDistance)) {
        ...
        nearLocation: function(position, targetLocation, nearDistance) {
            if (Math.abs(targetLocation.x - position.x) < nearDistance) {
                return true;
            }
            if (Math.abs(targetLocation.y - position.y) < nearDistance) {
                return true;
            }
            if (Math.abs(targetLocation.z - position.z) < nearDistance) {
                return true;
            }
            return false;
        },
